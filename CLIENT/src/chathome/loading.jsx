...
import Loading from './loadingsvg/loading.json'
import Loading1 from './loadingsvg/loading1.json'
import Loading2 from './loadingsvg/loading2.json'
import Loading3 from './loadingsvg/loading3.json'
import Loading4 from './loadingsvg/loading4.json'
import Loading5 from './loadingsvg/loading5.json'
import './style.css'
import Chatmenu from "./chatmenu";

const Chathome = () => {
    const animationData = [Loading,Loading1,Loading2,Loading3,Loading4,Loading5]; 
    const [animationIndex, setAnimationIndex] = useState(0);


    useEffect(() => {
        setAnimationIndex(Math.floor(Math.random() * animationData.length));
      });
	...
	/*if (loading===true) { 
     ...
     <div className="loadingcontainer">
            <div className="loadingsvg">
             <Lottie  animationData={animationData[animationIndex]}/>
             </div>
             <h1>loading...</h1>
